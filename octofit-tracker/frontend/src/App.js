              ...
              <div className="col-md-8">
                <div className="card shadow-lg border-0">
                  <div className="card-body text-center">
                    ...
                    <p className="card-text lead mb-4">Track your activities, join teams, compete on the leaderboard, and get personalized workout suggestions.</p>
                    <Link to="/activities" className="btn btn-primary btn-lg mx-2">View Activities</Link>
                    <Link to="/leaderboard" className="btn btn-outline-primary btn-lg mx-2">See Leaderboard</Link>
                  </div>
                </div>
              </div>
            </div>
